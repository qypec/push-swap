...
/*   Updated: 2020/02/07 23:00:13 by yquaro           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void							init_win_stacks(t_visu *visu)
{
	...
	visu->win_stack_b = newwin(WIN_STACK_LINES, WIN_STACK_COLS, 0, \
		WIN_STACK_COLS);
...
{
	visu->win_info = newwin(WIN_INFO_LINES, WIN_INFO_COLS, 0, \
		WIN_STACK_COLS * 2);
...
{
	visu->win_help = newwin(WIN_HELP_LINES, WIN_HELP_COLS, \
		WIN_STACK_LINES * 0.75, WIN_STACK_COLS * 2);
